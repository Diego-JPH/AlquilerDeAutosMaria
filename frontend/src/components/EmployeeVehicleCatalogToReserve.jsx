...
export default function EmployeeVehicleCatalogToReserve() {
  ...
  const handleReservar = (idVehiculo, idSucursal, precioPorDia) => {
    navigate(`/employee/create-reserve?idVehiculo=${idVehiculo}&idSucursal=${idSucursal}&fechaDesde=${fechaDesde}&fechaHasta=${fechaHasta}&precioPorDia=${precioPorDia}`);
  };
